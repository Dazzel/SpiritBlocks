package com.nijikokun.econ.register;
...
public class Methods {
     ...
     */
    private void _init() {
        this.addMethod("iConomy", new com.nijikokun.econ.register.methods.iCo6());
        this.addMethod("iConomy", new com.nijikokun.econ.register.methods.iCo5());
        this.addMethod("iConomy", new com.nijikokun.econ.register.methods.iCo4());
        this.addMethod("BOSEconomy", new com.nijikokun.econ.register.methods.BOSE6());
        this.addMethod("BOSEconomy", new com.nijikokun.econ.register.methods.BOSE7());
        this.addMethod("Essentials", new com.nijikokun.econ.register.methods.EE17());
        this.addMethod("MultiCurrency", new com.nijikokun.econ.register.methods.MCUR());
    }
